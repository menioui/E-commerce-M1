...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <meta name="author" content="Application E-Commerce développée avec le Framework Laravel 6 par Mohammed Mennioui">
    <meta name="generator" content="Jekyll v3.8.6">
    @yield('extra-meta')
    <title>Mennioui Shop</title>
  ...
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <a class="text-muted" href="{{route('cart.index')}}">Panier <span class="badge-pill badge-dark">{{ Cart::count()}}</span></a>
      </div>
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="{{route('products.index')}}"><img src="" alt="">🛍️ E-Shop</a>
      </div>
...
<footer class="blog-footer">
  <p><a href="https://getbootstrap.com/">BY Mohammed Mennioui</a> 🛒 E-shop</p>
  <p>
